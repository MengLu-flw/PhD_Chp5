#!/bin/bash
#SBATCH --job-name="13_Geumcf_deltaB_grid"
#SBATCH --output="/home/mlu/scratch/2_gimble/2024_May/Geum_cf_sym/Slurm/13_Geumcf_deltaB_grid.out"
#SBATCH --error="/home/mlu/scratch/2_gimble/2024_May/Geum_cf_sym/Slurm/13_Geumcf_deltaB_grid.err"
...
time gimble gridsearch -z Geum_cf_Gstore.z -p 50 \
					   -g makegrid/IM_BA_deltaB_240902 \
					   -d tally/windows_kmax2

##-4- Query gimble grids
time gimble query -z Geum_cf_Gstore.z -l gridsearch/windows_kmax2/IM_BA_deltaB_240902


##-5- Use awk to separate each chromosome

mv Geum_Gstore.gridsearch_windows_kmax2_IM_BA_deltaB_240902_0.best.bed queryGrid/Geum_Gstore.gridsearch_windows_kmax2_IM_BA_deltaB_240902.best.bed
...
awk -v n=1 '
    ...
    print header > name}
    {print $0 > name}
' Geum_Gstore.gridsearch_windows_kmax2_IM_BA_deltaB_240902.best.bed
...
cp Geum_Gstore.gridsearch_windows_kmax2_IM_BA_deltaB_240902.best.bed IM_BA_deltaB_240902.best.bed

data1=IM_BA_grid_240527.best.bed
data2=IM_BA_deltaB_240902.best.bed
...
rm IM_BA_deltaB_240902.best.bed
