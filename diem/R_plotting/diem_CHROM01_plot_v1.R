...
### ---- DI 0.5 (keep sites with top 50% highest DI)
load("diem_plot_CHORM01_DI0.5.RData")
getwd()
...
### ---- DI 0.8 (keep sites with top 20% highest DI)
load("diem_plot_CHORM01_DI0.8.RData")
getwd()
...
load("diem_plot_CHORM01_DI0.9.RData")
getwd()
