...
load("diem_plot_CHORM09_DI0.9.RData")
getwd()

# plotPolarized(geno, HI, xlab = "")
# plotMarkerAxis("OX327005.1-includedSites.txt", ChosenSites = fit_CHORM09$DI$DI > threshold)
...
# plotPolarized(geno, HI, labels = indNames_full) # This full label is too long to be displayed
...
plotPolarized(geno, HI, labels = indNames,
              c("#FFFFFF","#008080", "#FFE500", "#800080"),
              xlab = "", ylab = "")
